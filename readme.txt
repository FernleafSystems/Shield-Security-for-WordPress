...
= 8.5.4 - Current Release =
*Released: 4th February, 2020* - [Release Notes](https://shsec.io/gb)

* **(v.4)**  FIXED:		Further protection against errors if IP address is of a private network.
* **(v.4)**  FIXED:		Can't activate plugins in a particular scenario.
* **(v.4)**  FIXED:		Traffic Logger wasn't capturing traffic in some cases.
