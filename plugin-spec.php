{
  ...
  "includes":         {
    ...
    "register":     {
      "css": {
        "bootstrap":                         {
          "url": "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.2.3/css/bootstrap.min.css"
        },
        "select2":                           {
      ...
      "js":  {
        "bootstrap":                         {
          "url":  "https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.2.3/js/bootstrap.bundle.min.js",
          "deps": [
            "wp-jquery"
          ]
        },
