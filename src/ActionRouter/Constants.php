...
class Constants {
	...
	public const ACTIONS = [
		...
		Actions\PluginImportExport_DisconnectMaster::class,
		Actions\PluginImportExport_Enable::class,
		Actions\PluginImportExport_SetEnabled::class,
		...
		Actions\PluginImportExport_NetworkInviteRequest::class,
		...
		Actions\ReportingChartTrends::class,
		...
		Actions\Render\Components\Email\InstantAlerts\EmailInstantAlertAdminLogin::class,
		...
		Actions\Render\Components\Email\InstantAlerts\EmailInstantAlertFirewallBlock::class,
		...
		Actions\Render\Components\Reports\Contexts\EmailReportAlert::class,
		Actions\Render\Components\Reports\Contexts\EmailReportInfo::class,
		...
		Actions\Render\Components\ImportExport\FormAuthoriseUrls::class,
		Actions\Render\Components\ImportExport\ProfileOptionsForm::class,
		...
		Actions\Render\Components\Reports\ChartsTrends::class,
		...
		Actions\Render\FullPage\Report\SecurityReportAlert::class,
		...
		Actions\Render\PluginAdminPages\PageActionsQueueLanding::class,
