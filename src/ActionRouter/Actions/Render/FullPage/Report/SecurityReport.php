	...
	protected function getRenderData() :array {
		...
		return [
			...
			'strings' => [
				...
				'intro'               => $report->type === Constants::REPORT_TYPE_INFO
					? __( 'Current alert status is shown first, followed by detailed security activity for this reporting period.', 'wp-simple-firewall' )
					: __( 'This report outlines the most significant events and statistics on your WordPress site for given reporting period.', 'wp-simple-firewall' ),
