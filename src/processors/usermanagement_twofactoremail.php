...
if ( !class_exists( 'ICWP_WPSF_Processor_UserManagement_TwoFactorEmail', false ) ):

	require_once( dirname(__FILE__).ICWP_DS.'basedb.php' );

	class ICWP_WPSF_Processor_UserManagement_TwoFactorEmail extends ICWP_WPSF_BaseDbProcessor {
