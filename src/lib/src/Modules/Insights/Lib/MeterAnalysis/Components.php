		...
		return [
			...
			'audit_trail_enabled'      => function () {
				...
				return [
					...
					'href'             => $modAudit->isModOptEnabled() && $modAudit->getUrl_DirectLinkToOption( 'section_enable_audit_contexts' ),
					'protected'        => $optsAudit->isLogToDB(),
					'weight'           => 25,
				];
			},
