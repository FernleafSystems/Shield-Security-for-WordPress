...
class Strings extends Base\Strings {
	...
	public function getInsightStatNames() {
		return [
			...
			'wcf_scan_found'               => __( 'Found unrecognised file', 'wp-simple-firewall' ),
			...
			'ufc_scan_found'               => __( 'Found altered unrecognised file', 'wp-simple-firewall' ),
			...
			'options_exported'             => __( 'Plugin options exported', 'wp-simple-firewall' ),
	...
	protected function getAdditionalDisplayStrings() {
		...
		return [
			...
			'never'               => __( 'Recent Events Log', 'wp-simple-firewall' ),
