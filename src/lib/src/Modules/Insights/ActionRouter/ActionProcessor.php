...
class ActionProcessor {
	...
	public function enum() :array {
		return [
			...
			Actions\Render\Components\Email\PluginReport::class,
			...
			Actions\Render\Components\Reports\Alerts\FileLockerAlert::class,
			Actions\Render\Components\Reports\Alerts\ScanResultsAlert::class,
			Actions\Render\Components\Reports\Alerts\ScanRepairsAlert::class,
