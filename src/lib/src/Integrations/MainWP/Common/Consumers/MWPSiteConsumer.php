...
namespace FernleafSystems\Wordpress\Plugin\Shield\Integrations\MainWP\Common\Consumers;

use FernleafSystems\Wordpress\Plugin\Shield\Integrations\MainWP\Common\MWPSiteVO;

/**
 * Trait MWPSiteConsumer
 * @package FernleafSystems\Wordpress\Plugin\Shield\Integrations\MainWP\Common\Consumers
 */
trait MWPSiteConsumer {
