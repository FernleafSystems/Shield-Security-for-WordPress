...
class Constants {
	...
	public const ACTIONS = [
		...
		Actions\MfaWebauthnRemoveSource::class,
		Actions\MfaWebauthnAuthenticationStart::class,
		Actions\MfaWebauthnRegistrationStart::class,
		Actions\MfaWebauthnAuthenticationVerify::class,
		Actions\MfaWebauthnRegistrationVerify::class,
