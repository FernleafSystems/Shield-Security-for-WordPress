...
class BuildScanAction extends Shield\Scans\Base\BaseBuildScanAction {
	...
	protected function setCustomFields() {
		...
		$oAction->plugins = Services::WpPlugins()->getInstalledPluginFiles();
		$oAction->total_scan_items = count( $oAction->plugins );
		$oAction->item_processing_limit = $oAction->is_async ? 1 : 0;
