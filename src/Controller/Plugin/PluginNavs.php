	...
	public static function investigateLandingSubjectDefinitions() :array {
		return [
			'user'                 => [
				...
				'context_summary'   => __( 'Search or select a user to inspect matching sessions, activity, and request history.', 'wp-simple-firewall' ),
			...
			'ip'                   => [
				...
				'context_summary'   => __( 'Search or select an IP address to inspect matching sessions, activity, and request history.', 'wp-simple-firewall' ),
			...
			'plugin'               => [
				...
				'context_summary'   => __( 'Search or select a plugin to inspect integrity, vulnerabilities, and related activity.', 'wp-simple-firewall' ),
			...
			'theme'                => [
				...
				'context_summary'   => __( 'Search or select a theme to inspect integrity, vulnerabilities, and related activity.', 'wp-simple-firewall' ),
			...
			'core'                 => [
				...
				'context_summary'   => __( 'Review WordPress core integrity and platform activity from the same investigation panel.', 'wp-simple-firewall' ),
				'context_focus'     => __( 'Core file status and activity tied to the WordPress installation.', 'wp-simple-firewall' ),
				'context_next_step' => __( 'Switch between overview, file status, and activity to continue reviewing core files.', 'wp-simple-firewall' ),
