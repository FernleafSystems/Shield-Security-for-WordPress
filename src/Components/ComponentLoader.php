 ...
 * @property CompCons\SilentCaptcha\CoolDownHandler $cool_down
 ...
 * @property CompCons\SiteQueryCon                  $site_query
...
class ComponentLoader extends DynPropertiesClass {
	...
	private function getConsMap() :array {
		return [
			...
			'site_query'            => CompCons\SiteQueryCon::class,
