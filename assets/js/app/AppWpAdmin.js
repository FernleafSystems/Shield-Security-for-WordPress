...
import { SecurityAdminWpAdmin } from "../components/general/SecurityAdminWpAdmin";
...
export class AppWpAdmin extends AppBase {
	...
	initComponents() {
		...
		this.components.sec_admin = ( 'sec_admin' in comps ) ? new SecurityAdminWpAdmin( comps.sec_admin ) : null;
