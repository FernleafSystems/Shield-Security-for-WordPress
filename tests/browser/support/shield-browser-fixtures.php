...
function shield_browser_fixture_allowed_actions() :array {
	return [
		...
		'ip-detect-background' => [ 'seed', 'cleanup' ],
		'ip-rules-table' => [ 'seed', 'cleanup', 'inspect' ],
		'license-clear' => [ 'seed', 'cleanup', 'inspect' ],
		'live-traffic-toggle' => [ 'seed', 'cleanup', 'inspect' ],
...
function shield_browser_fixture_require_helpers() :void {
	...
	foreach ( [
		...
		'tests/Helpers/ActionRouter/ImportExportNetworkFixtureBuilder.php',
		'tests/Helpers/ActionRouter/IpAnalysisActivityMetaFixtureBuilder.php',
		'tests/Helpers/ActionRouter/IpDetectBackgroundFixtureBuilder.php',
		'tests/Helpers/ActionRouter/IpRulesTableFixtureBuilder.php',
		'tests/Helpers/ActionRouter/LicenseClearFixtureBuilder.php',
		'tests/Helpers/ActionRouter/LiveTrafficToggleFixtureBuilder.php',
