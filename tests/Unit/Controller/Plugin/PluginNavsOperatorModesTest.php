...
class PluginNavsOperatorModesTest extends BaseUnitTest {
	...
	public function test_actions_queue_scan_definitions_split_abandoned_without_ignored_only_keys() :void {
		...
		$this->assertSame( [ 'wp_files' ], $queueDefinitions[ 'wordpress' ][ 'summary_keys' ] );
		$this->assertSame( [ 'plugin_files' ], $queueDefinitions[ 'plugins' ][ 'summary_keys' ] );
		$this->assertSame( [ 'theme_files' ], $queueDefinitions[ 'themes' ][ 'summary_keys' ] );
