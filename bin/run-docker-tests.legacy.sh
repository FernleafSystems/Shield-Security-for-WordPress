#!/bin/bash
# Legacy package-first Docker test runner.
# This script is intentionally retained as an internal implementation target
# while mode routing is handled in bin/run-docker-tests.php.
