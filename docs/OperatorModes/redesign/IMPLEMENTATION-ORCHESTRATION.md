...
| G2 | T3 old-route wiring gate opened after subject key freeze | COMPLETE | codex-gpt5 | 2026-03-03 16:14 UTC | Subject keys/panel IDs frozen via T2-01,T2-02 and consumed by T3-01 legacy-route mapping to canonical panel contexts. |
...
| T3 | DONE | codex-gpt5 | 2026-03-03 12:28 UTC | 2026-03-03 16:14 UTC | T3-01 completed (legacy investigate routes now land on redesigned Investigate with canonical preselected panel context); T3-02,T3-03,T3-04 already DONE. |
| QA | NOT_STARTED | - | - | - | - |
...
| T3-01 | T3 | Route old investigate URLs to redesigned panel contexts | T2-01,T2-02 | DONE | codex-gpt5 | develop | 2026-03-03 16:05 UTC | 2026-03-03 16:14 UTC | workspace-uncommitted | Files: src/ActionRouter/Actions/Render/PageAdminPlugin.php, src/Controller/Plugin/PluginNavs.php, tests/Unit/ActionRouter/Render/PageAdminPluginBehaviorTest.php, tests/Unit/Controller/Plugin/PluginNavsOperatorModesTest.php, tests/Integration/ActionRouter/InvestigateByUserPageIntegrationTest.php, tests/Integration/ActionRouter/InvestigateByIpPageIntegrationTest.php, tests/Integration/ActionRouter/InvestigateByPluginPageIntegrationTest.php, tests/Integration/ActionRouter/InvestigateByThemePageIntegrationTest.php, tests/Integration/ActionRouter/InvestigateByCorePageIntegrationTest.php, tests/Integration/ActionRouter/OperatorBreadcrumbHeaderIntegrationTest.php. Tests: `php -l` on changed PHP files; `vendor/bin/phpunit -c phpunit-unit.xml --filter PageAdminPluginBehaviorTest`; `vendor/bin/phpunit -c phpunit-unit.xml --filter PluginNavsOperatorModesTest`; `vendor/bin/phpunit -c phpunit-unit.xml --filter BuildBreadCrumbsOperatorModesTest`; integration filters for investigate-by routes and operator breadcrumb executed but skipped due missing WP integration env. Risks: full WP integration execution pending environment availability. No forbidden edit zones crossed. Traceability: Section 2.2 T3 row + REDESIGN-OVERVIEW legacy route context mapping contract (3.5) and navigation contract (5) + user-journeys Journey 5/Cross-journey navigation rules. Unrelated workspace changes outside T3-01 touched files were ignored with no conflicts. |
